...
class EasyGuideLayer private constructor(private val anchor: View) {
    ...
    private var isInterceptClick = true
    ...
    /** 设置是否拦截点击事件*/
    fun setInterceptClick(isInterceptClick: Boolean): EasyGuideLayer {
        this.isInterceptClick = isInterceptClick
        return this
    }
    ...
    class GuideLayout(context: Context?) : FrameLayout(context), Controller, View.OnClickListener {
        ...
        override fun onTouchEvent(event: MotionEvent): Boolean {
            if (layer != null && layer?.isInterceptClick == false) {
                return false
            }
...
class GuideItem private constructor(val rect: RectF? = null, val view: View? = null, val padding: Int = 0) {
    ...
    fun setDrawable(@DrawableRes drawableRes: Int): GuideItem {
        ...
        this.drawable = FaceAppState.getApplication().resources.getDrawable(drawableRes)
        this.layout = 0
        return this
    }
