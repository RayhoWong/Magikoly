...
public class RoundedImageView extends ImageView {
    ...
    public void setIsDrawCircleLine(boolean isDrawCircleLine) {
        this.mIsDrawCircleLine = isDrawCircleLine;
        invalidate();
    }


    public  void setCircleLineColor(int color) {
        mCircleLinePaint.setColor(color);
    }

    private boolean mIsDrawCircleLine;
    ...
    public RoundedImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        final int tileMode = a.getInt(R.styleable.RoundedImageView_go_riv_tile_mode, TILE_MODE_UNDEFINED);
        ...
        final int tileModeX =
                a.getInt(R.styleable.RoundedImageView_go_riv_tile_mode_x, TILE_MODE_UNDEFINED);
        if (tileModeX != TILE_MODE_UNDEFINED) {
            setTileModeX(parseTileMode(tileModeX));
        }

        final int tileModeY =
                a.getInt(R.styleable.RoundedImageView_go_riv_tile_mode_y, TILE_MODE_UNDEFINED);
        ...
        mCircleLinePaint.setStrokeWidth(DrawUtils.dip2px(3));
        mCircleLinePaint.setColor(Color.RED);
    }
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        if (mIsDrawCircleLine) {
            int width = getWidth();
            int height = getHeight();
            int radius = (Math.min(width, height) - DrawUtils.dip2px(3)) / 2;
            canvas.drawCircle(width/ 2, height / 2, radius, mCircleLinePaint);
        }
    }
    ...
    protected void updateAttrs(Drawable drawable) {
