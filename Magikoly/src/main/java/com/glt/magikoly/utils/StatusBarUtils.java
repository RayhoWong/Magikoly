...
public class StatusBarUtils {
    ...
    public static void statusBarLightMode(Activity activity) {
        ...
        } else if (Machine.IS_SDK_ABOVE_LOLIP) {
            StatusBarHandler.setStatusBarTransparentLollipop(activity.getWindow(), true);
            int option = View.SYSTEM_UI_FLAG_LAYOUT_FULLSCREEN | View.SYSTEM_UI_FLAG_LAYOUT_STABLE;
            activity.getWindow().getDecorView().setSystemUiVisibility(option);
        } else if(Machine.IS_SDK_ABOVE_KITKAT){
            StatusBarHandler.setStatusBarTransparentLollipop(activity.getWindow(), true);
            int option = SYSTEM_UI_FLAG_LAYOUT_FULLSCREEN;
            if (Machine.canHideNavBar()) {
                option = option | SYSTEM_UI_FLAG_LAYOUT_HIDE_NAVIGATION;
            }
            activity.getWindow().getDecorView().setSystemUiVisibility(option);
        }
    }
     ...
     *
     * @param activity
     * @param type     1:MIUUI 2:Flyme 3:android6.0 4:android6.0以下
     */
