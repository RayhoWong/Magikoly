...
import com.glt.magikoly.cache.ICache;
import com.glt.magikoly.cache.ICacheListener;
import com.glt.magikoly.cache.IModuleKey;
import com.glt.magikoly.cache.compress.ICompress;
import com.glt.magikoly.cache.encrypt.IEncrypt;
...
public abstract class BaseCacheImpl implements ICache, IModuleKey {
	...
	public boolean getIsCompress() {
		return mCompress != null;
	}
	
	public boolean getIsEncrypt() {
		return mEncrypt != null;
	}
