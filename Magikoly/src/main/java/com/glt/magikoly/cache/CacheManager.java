 ...
 * @date  [2012-9-25]
 */
public class CacheManager implements com.glt.magikoly.cache.ICache, com.glt.magikoly.cache.IModuleKey {
	...
	@Override
	public void saveCacheAsync(String key, byte[] cacheData, com.glt.magikoly.cache.ICacheListener listener) {
		if (mCacheImpl != null) {
	...
	@Override
	public void loadCacheAsync(String key, com.glt.magikoly.cache.ICacheListener listener) {
		if (mCacheImpl != null) {
