package com.xfeng.cameralibrary.camera;
...
import com.xfeng.beautyfacelib.Filter.camerafiter.AFilter;
import com.xfeng.beautyfacelib.Filter.camerafiter.EasyGlUtils;
import com.xfeng.beautyfacelib.Filter.camerafiter.GroupFilter;
import com.xfeng.beautyfacelib.Filter.camerafiter.MatrixUtils;
import com.xfeng.beautyfacelib.Filter.camerafiter.NoFilter;
...
public class TextureController implements GLSurfaceView.Renderer {
    ...
    public static final int DEFAULT_RENDER_WIDTH = 720;
    public static final int DEFAULT_RENDER_HEIGHT = 1280;
    ...
    private GLSurfaceListener surfaceListener;

    public TextureController(Context context, GLSurfaceListener listener) {
    ...
    private void init(){
        ...
        mDataSize = new Point(DEFAULT_RENDER_WIDTH, DEFAULT_RENDER_HEIGHT);

        mWindowSize = new Point(DEFAULT_RENDER_WIDTH, DEFAULT_RENDER_HEIGHT);
    }
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        if (surfaceListener != null) {
            surfaceListener.onGLSurfaceCreated();
        }
    }
